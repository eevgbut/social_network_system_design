...
Disks_for_capacity = 315 TB / 100 ТВ = 4
Disks_for_throughput = 20 МБ/с / 100 МБ/с = ~1
Disks_for_iops = 8000 / 1 000 = 8
Disks = max(ceil(4), ceil(1), ceil(8)) = 8
```

Итог: поскольку данных не много, но IOPS достаточно большой – выбираем SSD диски небольшого объема.
...
Итог: необходимо много дисков, выбираем 75 дешевых дисков HDD по максимальному объему (по iops есть запас X3)